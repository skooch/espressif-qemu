...
typedef struct Esp32s3RtcCntlState {
    ...
    uint32_t retention_ctrl_reg;
    uint32_t pg_ctrl_reg;
    uint32_t fib_sel_reg;
    uint32_t touch_dac_reg;
    uint32_t touch_dac1_reg;
    uint32_t cocpu_disable_reg;
    uint32_t rtc_reg;
    uint32_t pwc_reg;
...
REG32(RTC_CNTL_RETENTION_CTRL, 0x140)
    FIELD(RTC_CNTL_RETENTION_CTRL, RETENTION_WAIT, 25, 7)
    FIELD(RTC_CNTL_RETENTION_CTRL, RETENTION_EN, 24, 1)
    FIELD(RTC_CNTL_RETENTION_CTRL, RETENTION_CLKOFF_WAIT, 20, 4)
    FIELD(RTC_CNTL_RETENTION_CTRL, RETENTION_DONE_WAIT, 17, 3)
    FIELD(RTC_CNTL_RETENTION_CTRL, RETENTION_CLK_SEL, 16, 1)
    FIELD(RTC_CNTL_RETENTION_CTRL, RETENTION_TARGET, 14, 2)
    FIELD(RTC_CNTL_RETENTION_CTRL, RETENTION_TAG_MODE, 10, 4)

REG32(RTC_CNTL_PG_CTRL, 0x144)
    FIELD(RTC_CNTL_PG_CTRL, POWER_GLITCH_EN, 31, 1)
    FIELD(RTC_CNTL_PG_CTRL, POWER_GLITCH_EFUSE_SEL, 30, 1)
    FIELD(RTC_CNTL_PG_CTRL, POWER_GLITCH_FORCE_PU, 29, 1)
    FIELD(RTC_CNTL_PG_CTRL, POWER_GLITCH_FORCE_PD, 28, 1)
    FIELD(RTC_CNTL_PG_CTRL, POWER_GLITCH_DSENSE, 26, 2)

REG32(RTC_CNTL_FIB_SEL, 0x148)
    FIELD(RTC_CNTL_FIB_SEL, FIB_SEL, 0, 3)

REG32(RTC_CNTL_TOUCH_DAC, 0x14c)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD0_DAC, 29, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD1_DAC, 26, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD2_DAC, 23, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD3_DAC, 20, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD4_DAC, 17, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD5_DAC, 14, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD6_DAC, 11, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD7_DAC, 8, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD8_DAC, 5, 3)
    FIELD(RTC_CNTL_TOUCH_DAC, TOUCH_PAD9_DAC, 2, 3)

REG32(RTC_CNTL_TOUCH_DAC1, 0x150)
    FIELD(RTC_CNTL_TOUCH_DAC1, TOUCH_PAD10_DAC, 29, 3)
    FIELD(RTC_CNTL_TOUCH_DAC1, TOUCH_PAD11_DAC, 26, 3)
    FIELD(RTC_CNTL_TOUCH_DAC1, TOUCH_PAD12_DAC, 23, 3)
    FIELD(RTC_CNTL_TOUCH_DAC1, TOUCH_PAD13_DAC, 20, 3)
    FIELD(RTC_CNTL_TOUCH_DAC1, TOUCH_PAD14_DAC, 17, 3)

REG32(RTC_CNTL_COCPU_DISABLE, 0x154)
    FIELD(RTC_CNTL_COCPU_DISABLE, DISABLE_RTC_CPU, 31, 1)
