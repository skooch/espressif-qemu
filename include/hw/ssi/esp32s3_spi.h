...
REG32(SPI_MEM_CACHE_SCTRL, 0x040)
    FIELD(SPI_MEM_CACHE_SCTRL, CACHE_SRAM_USR_RCMD, 24, 8)
    FIELD(SPI_MEM_CACHE_SCTRL, SRMEM_USR_DUMMY, 21, 1)
    FIELD(SPI_MEM_CACHE_SCTRL, SRMEM_USR_ADDR, 20, 1)
    FIELD(SPI_MEM_CACHE_SCTRL, SRMEM_USR_COMMAND, 19, 1)
    FIELD(SPI_MEM_CACHE_SCTRL, SRMEM_WDUMMY, 18, 1)
    FIELD(SPI_MEM_CACHE_SCTRL, SRMEM_OCT, 17, 1)
    FIELD(SPI_MEM_CACHE_SCTRL, SRMEM_QUAD, 16, 1)

REG32(SPI_MEM_SRAM_DRD_CMD, 0x048)
    FIELD(SPI_MEM_SRAM_DRD_CMD, CACHE_SRAM_USR_RD_CMD_BITLEN, 28, 4)
    FIELD(SPI_MEM_SRAM_DRD_CMD, CACHE_SRAM_USR_RD_CMD_VALUE, 0, 16)

REG32(SPI_MEM_SRAM_DWR_CMD, 0x04C)
    FIELD(SPI_MEM_SRAM_DWR_CMD, CACHE_SRAM_USR_WR_CMD_BITLEN, 28, 4)
    FIELD(SPI_MEM_SRAM_DWR_CMD, CACHE_SRAM_USR_WR_CMD_VALUE, 0, 16)

REG32(SPI_MEM_SRAM_CLK, 0x050)
    FIELD(SPI_MEM_SRAM_CLK, SCLK_EQU_SYSCLK, 31, 1)
    FIELD(SPI_MEM_SRAM_CLK, SCLKCNT_N, 16, 8)
    FIELD(SPI_MEM_SRAM_CLK, SCLKCNT_H, 8, 8)
    FIELD(SPI_MEM_SRAM_CLK, SCLKCNT_L, 0, 8)
...
REG32(SPI_MEM_SPI_SMEM_AC, 0x0DC)
    FIELD(SPI_MEM_SPI_SMEM_AC, SPI_SMEM_CS_HOLD_DELAY, 27, 6)
    FIELD(SPI_MEM_SPI_SMEM_AC, SPI_SMEM_CS_HOLD_TIME, 14, 13)
    FIELD(SPI_MEM_SPI_SMEM_AC, SPI_SMEM_CS_SETUP_TIME, 1, 13)
    FIELD(SPI_MEM_SPI_SMEM_AC, SPI_SMEM_CS_HOLD_DELAY_RES, 0, 1)
...
REG32(SPI_MEM_CORE_CLK_SEL, 0x0EC)
    FIELD(SPI_MEM_CORE_CLK_SEL, SPI01_CLK_SEL, 0, 2)
