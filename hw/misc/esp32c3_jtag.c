...
static uint64_t esp32c3_jtag_read(void *opaque, hwaddr addr, unsigned int size)
{
    ...
    case USB_SERIAL_JTAG_EP1_REG:
        /* RX path not implemented — return 0 */
        return 0;

    case USB_SERIAL_JTAG_EP1_CONF_REG:
        /*
         * Bit 1 (SERIAL_IN_EP_DATA_FREE): Always report FIFO ready.
         * The firmware checks this bit before writing each byte.
         * Returning 1 here means the firmware never spins waiting for space.
         */
        return 0x02;
