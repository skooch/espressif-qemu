...
- 2026-04-16: Verified `QTEST_QEMU_BINARY=build/qemu-system-xtensa ./build/tests/qtest/esp32s3-test -p /xtensa/esp32s3/system -p /xtensa/esp32s3/intmatrix -p /xtensa/esp32s3/rtc/clk-conf-register-contract -p /xtensa/esp32s3/uart/clock-timing` passes 4/4 after the Phase 5 clock/interrupt changes.
