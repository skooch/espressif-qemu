...
- Supported RTC_CNTL offsets: `0x000`, `0x004`, `0x008`, `0x00c`, `0x010`, `0x014`, `0x018`, `0x020`, `0x038`, `0x03c`, `0x044`, `0x04c`, `0x050`-`0x05c`, `0x064`, `0x068`, `0x074`, `0x07c`, `0x080`, `0x084`, `0x088`, `0x08c`, `0x090`, `0x0b0`, `0x0b4`, `0x0b8`, `0x0bc`, `0x0c0`-`0x0cc`, `0x0d8`, `0x0dc`, `0x0e0`, `0x0e4`, `0x130`, and `0x1fc`.
...
This is a QEMU-visible SoC transition contract and a guest-level recovery regression, not hardware proof of full ESP32-S3 low-power behavior. The local sleep reference still identifies broader missing behavior beyond the now-modeled XTAL handoff and wake-stub clock contract: stop XTAL/PLL and usually RC_FAST with real settling timing, compensate stopped SYSTIMER time on wake, model power-domain and peripheral gating decisions, and handle CPU retention/power-down variants. Those remain blocked for accuracy until each item is backed by the local TRM/ESP-IDF/esp-hal evidence or a hardware probe.
